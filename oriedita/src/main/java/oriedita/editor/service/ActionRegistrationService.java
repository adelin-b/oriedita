    ...
    public void registerActionsInitial() {
        ...
        for (Map.Entry<ActionType, MouseMode> entry : mouseModeWithUnselectActions.entrySet()) {
            actionService.registerAction(entry.getKey(),
                    actionFactory.setMouseModeWithUnselectAction(entry.getValue()));
        }
        ...
        Map<ActionType, MouseMode> mouseModeWithAfterColorAndUnselectActions = new HashMap<>() {
            {
                ...
                put(ActionType.drawBlintzAction, MouseMode.DRAW_BLINTZ);
                put(ActionType.drawFishBaseAction, MouseMode.DRAW_FISH_BASE);
                put(ActionType.drawDoveBaseAction, MouseMode.DRAW_DOVE_BASE);
                put(ActionType.drawBirdBaseAction, MouseMode.DRAW_BIRD_BASE);
                put(ActionType.drawFrogBaseAction, MouseMode.DRAW_FROG_BASE);
        ...
        for (Map.Entry<ActionType, MouseMode> entry : mouseModeWithAfterColorAndUnselectActions.entrySet()) {
            actionService.registerAction(entry.getKey(),
                    actionFactory.setMouseModeWithAfterColorAndUnselectAction(entry.getValue()));
        }

        // |---------------------------------------------------------------------------|
        // Categorized by sections in each panel (improvements towards such are
        // appreciated)
        // |---------------------------------------------------------------------------|
        // --- Left Panel ---
        // - line actions
        actionService.registerAction(ActionType.colRedAction,
                new LambdaAction(() -> canvasModel.setLineColor(LineColor.RED_1)));
        actionService.registerAction(ActionType.colBlueAction,
                new LambdaAction(() -> canvasModel.setLineColor(LineColor.BLUE_2)));
        actionService.registerAction(ActionType.colBlackAction,
                new LambdaAction(() -> canvasModel.setLineColor(LineColor.BLACK_0)));
        actionService.registerAction(ActionType.colCyanAction,
                new LambdaAction(() -> canvasModel.setLineColor(LineColor.CYAN_3)));
        actionService.registerAction(ActionType.antiAliasToggleAction,
                new LambdaAction(applicationModel::toggleAntiAlias));
        actionService.registerAction(ActionType.lineWidthDecreaseAction,
                new LambdaAction(applicationModel::decreaseLineWidth));
        actionService.registerAction(ActionType.lineWidthIncreaseAction,
                new LambdaAction(applicationModel::increaseLineWidth));
        actionService.registerAction(ActionType.pointSizeDecreaseAction,
                new LambdaAction(applicationModel::decreasePointSize));
        actionService.registerAction(ActionType.pointSizeIncreaseAction,
                new LambdaAction(applicationModel::increasePointSize));
        actionService.registerAction(ActionType.lineStyleChangeAction,
                new LambdaAction(applicationModel::advanceLineStyle));
        ...
        // - tab actions
        actionService.registerAction(ActionType.drawingTabAction,
                new LambdaAction(() -> canvasModel.setSelectedToolTab(ToolTab.DRAW)));
        actionService.registerAction(ActionType.foldingTabAction,
                new LambdaAction(() -> canvasModel.setSelectedToolTab(ToolTab.FOLD)));
        actionService.registerAction(ActionType.referencesTabAction,
                new LambdaAction(() -> canvasModel.setSelectedToolTab(ToolTab.REFERENCE)));
        actionService.registerAction(ActionType.settingsTabAction,
                new LambdaAction(() -> canvasModel.setSelectedToolTab(ToolTab.SETTINGS)));

        // - line edit actions
        actionService.registerAction(ActionType.v_del_allAction, new LambdaAction(mainCreasePatternWorker::v_del_all));
        actionService.registerAction(ActionType.v_del_all_ccAction,
                new LambdaAction(mainCreasePatternWorker::v_del_all_cc));
        ...
        actionService.registerAction(ActionType.lineSegmentDeleteAction, actionFactory.setMouseModeLineTypeDeleteAction(
                MouseMode.LINE_SEGMENT_DELETE_3, FoldLineAdditionalInputMode.POLY_LINE_0));
        actionService.registerAction(ActionType.edgeLineSegmentDeleteAction,
                actionFactory.setMouseModeLineTypeDeleteAction(MouseMode.LINE_SEGMENT_DELETE_3,
                        FoldLineAdditionalInputMode.BLACK_LINE_2));
        actionService.registerAction(ActionType.auxLiveLineSegmentDeleteAction,
                actionFactory.setMouseModeLineTypeDeleteAction(MouseMode.LINE_SEGMENT_DELETE_3,
                        FoldLineAdditionalInputMode.AUX_LIVE_LINE_3));
        ...
        // - grid actions
        actionService.registerAction(ActionType.gridSizeIncreaseAction,
                new LambdaAction(() -> gridModel.setGridSize(gridModel.getGridSize() * 2)));
        actionService.registerAction(ActionType.gridSizeDecreaseAction,
                new LambdaAction(() -> gridModel.setGridSize(Math.max(gridModel.getGridSize() / 2, 1))));
        actionService.registerAction(ActionType.changeGridStateAction, new LambdaAction(gridModel::advanceBaseState));
        actionService.registerAction(ActionType.gridLineWidthDecreaseAction,
                new LambdaAction(applicationModel::decreaseGridLineWidth));
        actionService.registerAction(ActionType.gridLineWidthIncreaseAction,
                new LambdaAction(applicationModel::increaseGridLineWidth));
        actionService.registerAction(ActionType.moveIntervalGridVerticalAction,
                new LambdaAction(gridModel::changeHorizontalScalePosition));
        actionService.registerAction(ActionType.moveIntervalGridHorizontalAction,
                new LambdaAction(gridModel::changeVerticalScalePosition));
        ...
        actionService.registerAction(ActionType.gridColorAction, new LambdaAction(() -> {
            // 以下にやりたいことを書く
            Color color = JColorChooser.showDialog(frameProvider.get(), "Col",
                    FlatLaf.isLafDark() ? Colors.GRID_LINE_DARK : Colors.GRID_LINE);
            if (color != null) {
                applicationModel.setGridColor(color);
            }
            // 以上でやりたいことは書き終わり
        }));
        actionService.registerAction(ActionType.drawDiagonalGridlinesAction,
                new LambdaAction(() -> gridModel.setDrawDiagonalGridlines(!gridModel.getDrawDiagonalGridlines())));
        actionService.registerAction(ActionType.intervalGridColorAction, new LambdaAction(() -> {
            Color color = JColorChooser.showDialog(frameProvider.get(), "Col",
                    FlatLaf.isLafDark() ? Colors.GRID_SCALE_DARK : Colors.GRID_SCALE);
            if (color != null) {
        ...
        // - other actions
        actionService.registerAction(ActionType.suitei_01Action,
                actionFactory.suiteiAction(FoldedFigure.EstimationOrder.ORDER_1));
        actionService.registerAction(ActionType.suitei_02Action,
                actionFactory.suiteiAction(FoldedFigure.EstimationOrder.ORDER_2));
        actionService.registerAction(ActionType.suitei_03Action,
                actionFactory.suiteiAction(FoldedFigure.EstimationOrder.ORDER_3));
        actionService.registerAction(ActionType.drawTwoColoredCpAction,
                new LambdaAction(foldingService::createTwoColoredCp));
        actionService.registerAction(ActionType.coloredXRayDecreaseAction,
                new LambdaAction(foldedFigureModel::decreaseTransparency));
        actionService.registerAction(ActionType.coloredXRayIncreaseAction,
                new LambdaAction(foldedFigureModel::increaseTransparency));
        actionService.registerAction(ActionType.koteimen_siteiAction, new LambdaAction(() -> {
            FoldedFigure_Drawer selectedFigure = foldedFiguresList.getActiveItem();

            if (selectedFigure != null
                    && selectedFigure.getFoldedFigure().displayStyle != FoldedFigure.DisplayStyle.NONE_0) {
        ...
        actionService.registerAction(ActionType.selectPersistentAction,
                new LambdaAction(() -> applicationModel.setSelectPersistent(!applicationModel.getSelectPersistent())));

        // |---------------------------------------------------------------------------|
        // --- Top Panel ---
        // - transform CP(crease pattern) actions
        actionService.registerAction(ActionType.rotateClockwiseAction,
                new LambdaAction(() -> animationService.animate(Animations.ROTATE_CP,
                        cameraModel::setRotation,
                        cameraModel::getRotation,
                        r -> r - angleSystemModel.getAngleStep(),
                        AnimationDurations.ZOOM)));
        actionService.registerAction(ActionType.rotateAnticlockwiseAction,
                new LambdaAction(() -> animationService.animate(Animations.ROTATE_CP,
                        cameraModel::setRotation,
                        cameraModel::getRotation,
                        r -> r + angleSystemModel.getAngleStep(),
        ...
        // - background actions
        actionService.registerAction(ActionType.transparentAction,
                new LambdaAction(canvas::createTransparentBackground));
        actionService.registerAction(ActionType.backgroundLockAction,
                new LambdaAction(() -> backgroundModel.setLockBackground(!backgroundModel.isLockBackground())));
        actionService.registerAction(ActionType.backgroundToggleAction,
                new LambdaAction(() -> backgroundModel.setDisplayBackground(!backgroundModel.isDisplayBackground())));

        // |---------------------------------------------------------------------------|
        // --- Right panel ---
        // - validation actions
        actionService.registerAction(ActionType.ck4_colorDecreaseAction,
                new LambdaAction(mainCreasePatternWorker::lightenCheck4Color));
        actionService.registerAction(ActionType.ck4_colorIncreaseAction,
                new LambdaAction(mainCreasePatternWorker::darkenCheck4Color));
        ...
        actionService.registerAction(ActionType.angleSystemADecreaseAction,
                new LambdaAction(angleSystemModel::decreaseAngleSystemA));
        actionService.registerAction(ActionType.angleSystemAAction, new LambdaAction(
                () -> angleSystemModel.setCurrentAngleSystemDivider(angleSystemModel.getAngleSystemADivider())));
        actionService.registerAction(ActionType.angleSystemAIncreaseAction,
                new LambdaAction(angleSystemModel::increaseAngleSystemA));
        actionService.registerAction(ActionType.angleSystemBDecreaseAction,
                new LambdaAction(angleSystemModel::decreaseAngleSystemB));
        actionService.registerAction(ActionType.angleSystemBAction, new LambdaAction(
                () -> angleSystemModel.setCurrentAngleSystemDivider(angleSystemModel.getAngleSystemBDivider())));
        actionService.registerAction(ActionType.angleSystemBIncreaseAction,
                new LambdaAction(angleSystemModel::increaseAngleSystemB));
        actionService.registerAction(ActionType.restrictedAngleABCSetAction,
                new LambdaAction(angleSystemModel::setCurrentABC));
        actionService.registerAction(ActionType.deg1Action, actionFactory
                .degAction(MouseMode.DRAW_CREASE_ANGLE_RESTRICTED_13, AngleSystemModel.AngleSystemInputType.DEG_1));
        actionService.registerAction(ActionType.deg2Action, actionFactory
                .degAction(MouseMode.DRAW_CREASE_ANGLE_RESTRICTED_5_37, AngleSystemModel.AngleSystemInputType.DEG_5));
        actionService.registerAction(ActionType.deg3Action,
                actionFactory.degAction(MouseMode.ANGLE_SYSTEM_16, AngleSystemModel.AngleSystemInputType.DEG_2));
        actionService.registerAction(ActionType.deg4Action, actionFactory
                .degAction(MouseMode.DRAW_CREASE_ANGLE_RESTRICTED_3_18, AngleSystemModel.AngleSystemInputType.DEG_4));

        // - other aux actions
        actionService.registerAction(ActionType.colOrangeAction,
                new LambdaAction(() -> canvasModel.setAuxLiveLineColor(LineColor.ORANGE_4)));
        actionService.registerAction(ActionType.colYellowAction,
                new LambdaAction(() -> canvasModel.setAuxLiveLineColor(LineColor.YELLOW_7)));
        actionService.registerAction(ActionType.h_senhaba_sageAction,
                new LambdaAction(applicationModel::decreaseAuxLineWidth));
        actionService.registerAction(ActionType.h_senhaba_ageAction,
                new LambdaAction(applicationModel::increaseAuxLineWidth));
        actionService.registerAction(ActionType.h_senbun_nyuryokuAction, actionFactory.setMouseModeLineTypeDeleteAction(
                MouseMode.DRAW_CREASE_FREE_1, FoldLineAdditionalInputMode.AUX_LINE_1));
        actionService.registerAction(ActionType.h_senbun_sakujyoAction, actionFactory.setMouseModeLineTypeDeleteAction(
                MouseMode.LINE_SEGMENT_DELETE_3, FoldLineAdditionalInputMode.AUX_LINE_1));
        ...
        actionService.registerAction(ActionType.foldedFigureToggleAntiAliasAction,
        ...
        actionService.registerAction(ActionType.foldedFigureSizeIncreaseAction,
                new LambdaAction(() -> animationService.animate(Animations.ZOOM_FOLDED_MODEL,
                        ...
                        AnimationDurations.ZOOM)));
        actionService.registerAction(ActionType.foldedFigureSizeDecreaseAction,
                new LambdaAction(() -> animationService.animate(Animations.ZOOM_FOLDED_MODEL,
                        foldedFigureModel::setScale,
                        foldedFigureModel::getScale,
                        scale -> foldedFigureModel.getScaleForZoomBy(1, applicationModel.getZoomSpeed(), scale),
                        AnimationDurations.ZOOM)));
        actionService.registerAction(ActionType.foldedFigureRotateClockwiseAction,
                new LambdaAction(() -> animationService.animate(Animations.ROTATE_FOLDED_MODEL,
                        ...
                        AnimationDurations.ZOOM)));
        actionService.registerAction(ActionType.foldedFigureRotateAntiClockwiseAction,
                new LambdaAction(() -> animationService.animate(Animations.ROTATE_FOLDED_MODEL,
                        foldedFigureModel::setRotation,
                        foldedFigureModel::getRotation,
                        r -> foldedFigureModel.getState() == FoldedFigure.State.BACK_1 ? r - 11.25 : r + 11.25,
        ...
        actionService.registerAction(ActionType.oriagari_sousa_2Action,
                actionFactory.oriagari_sousaAction(FoldedFigureOperationMode.MODE_2));

        // |---------------------------------------------------------------------------|
        // --- AppMenuBar ---
        actionService.registerAction(ActionType.IMPORT, new LambdaAction(fileSaveService::importFile));
        actionService.registerAction(ActionType.toggleHelpAction,
                new LambdaAction(applicationModel::toggleHelpVisible));

        // --- others ---
        actionService.registerAction(ActionType.scaleAction,
                new LambdaAction(() -> animationService.animate(Animations.ZOOM_FOLDED_MODEL,
                        foldedFigureModel::setScale,
                        foldedFigureModel::getScale,
                        1.0,
